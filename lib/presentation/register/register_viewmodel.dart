...
class RegisterViewModel extends BaseViewModel
  ...
  /*
  I will depend on the output of this stream, after applying map on the stream the output
  is (isUserNameValid) which is bool. if it's valid then empty error.
...
abstract class RegisterViewModelOutputs {
  ...
  /*
  I will listen to the input from the sink up there, and once
  I receive it, I will call the first stream here (outputIsUserNameValid),
  then I have to do a validation which returning bool.
  After that I will use this return bool inside (outputIsUserNameValid)
  if it's valid I will return empty or null error message.
  Otherwise, I have to return the error message that I have to show inside
  the view
  */
  ...
  /*
  No need for another stream here, Because no validation here,
  no error message.
  */
  Stream<File> get outputProfilePicture;
